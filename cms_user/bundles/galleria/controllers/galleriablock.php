...
class Galleria_Galleriablock_Controller extends Base_Controller {
    ...
    public function get_render($params) {
       ...
       $content = Galleria\Models\Galleriablock::find($params['block_id']);

       $id = $content->id;
       $handle = 'galleriablock';
      ...
      $set = array();
       ...
       $view = Block::template('galleria', $content->template);
